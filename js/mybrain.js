...
d3.csv("https://vsoch.github.io/mybrain/data/mybrain_nodes.csv", function(error, nodes) {
...
function update_data() {  
  data = d3.csv("https://vsoch.github.io/mybrain/data/mybrain_data.csv", function(data) {
